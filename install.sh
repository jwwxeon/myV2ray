...
config_docker(){
    ...
    curl -L https://github.com/jwwxeon/myV2ray/blob/master/docker-compose.yml > docker-compose.yml
...
config_caddy_docker(){
    ...
    echo "install curl"
    install_dependencies
    curl -L https://github.com/jwwxeon/myV2ray/blob/master/Caddyfile >  Caddyfile
    echo "Writing docker-compose.yml"
    curl -L https://github.com/jwwxeon/myV2ray/blob/master/docker-compose.yml > docker-compose.yml
    sed -i "s|node_id:.*|node_id: ${ssrpanel_node_id}|"  ./docker-compose.yml
    sed -i "s|sspanel_url:.*|sspanel_url: '${ssrpanel_url}'|"  ./docker-compose.yml
